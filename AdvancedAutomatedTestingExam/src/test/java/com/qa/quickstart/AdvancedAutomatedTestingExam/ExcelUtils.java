...
import com.qa.quickstart.AdvancedAutomatedTestingExam.Constants;
...
public class ExcelUtils {
	...
	public static void setCellData(String Result, int RowNum, int ColNum) {
		...
		try {
			...
			FileOutputStream fileOut = new FileOutputStream(Constants.excelFilepath + Constants.excelFileName);
